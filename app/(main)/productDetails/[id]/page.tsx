          ...
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col">
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-4">
                <h4 className="text-[11px] font-bold uppercase tracking-widest">Select Size</h4>
                <button className="text-[10px] underline text-gray-400 font-bold hover:text-black uppercase">Size Guide</button>
              </div>
            ...
            <div className="border-t border-b divide-y divide-gray-100">
              ...
              >
                <p className="text-[12px] text-gray-600 leading-relaxed pb-2">
                  7 days easy return policy. Ensure tags are intact for a hassle-free exchange.
                </p>
              </AccordionItem>
            </div>
          </div>
